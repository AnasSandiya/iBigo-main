...
//  iBigo
//
//  Created by pc link on 30/06/2021.
//
...
public class CheckMarkView: UIView {
    ...
    func drawRectChecked(rect: CGRect) {
        ...
        let checkmarkBlue =  #colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1) // UIColor(red: 0.078, green: 0.435, blue: 0.875, alpha: 1)
